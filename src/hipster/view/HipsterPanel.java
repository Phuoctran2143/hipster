...
public class HipsterPanel extends JPanel
{
	...
	public HipsterPanel(HipsterController baseController)
	{
		...
		baseLayout.putConstraint(SpringLayout.EAST, dropDown, 367, SpringLayout.WEST, this);
		setupPanel();
		setupLayout();
		setupListeners();
	}
	...
	private void setupLayout()
	{
		...
		baseLayout.putConstraint(SpringLayout.WEST, myButton, 151, SpringLayout.WEST, this);
		baseLayout.putConstraint(SpringLayout.SOUTH, myButton, -101, SpringLayout.SOUTH, this);
		baseLayout.putConstraint(SpringLayout.NORTH, infoLabel, 10, SpringLayout.NORTH, this);
		baseLayout.putConstraint(SpringLayout.WEST, infoLabel, 167, SpringLayout.WEST, this);
